...
const (
	...
	ClineRuleTemplate = `# Cerebras MCP Integration
...
# Use it for file creation, editing, and code generation`
	...
	CursorRuleTemplate = `# Cerebras MCP Integration
# Generated by mcp-code-api configuration wizard
...
# - The MCP server handles all file operations`
	...
	VSCodeExtensionTemplate = `{"mcpServers":{"cerebras-mcp":{"command":"mcp-code-api","args":["server"]}}`
...
const (
	...
	DefaultConfigFile     = ".cerebras-mcp.yaml"
	DefaultMCPConfigFile  = ".mcp-config.json"
	DefaultExtensionsFile = "extensions.json"
	DefaultRulesFile      = "cerebras-mcp-rules.md"
